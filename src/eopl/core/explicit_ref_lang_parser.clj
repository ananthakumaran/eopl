(ns eopl.core.explicit-ref-lang-parser
...
(defn primitive-exp [rator rands]
  (let [result (cases expression rator
                 (var-exp (var)
                          (apply
                           (ns-resolve 'eopl.core.explicit-ref-lang-parser
...
(def-parse-1-arg newref "newref")
(def-parse-1-arg de-ref "de-ref")
(def-parse-2-arg setref "setref")
