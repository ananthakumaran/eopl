(ns eopl.core.mixed-ref-lang-parser
...
(defn primitive-exp [rator rands]
  (let [result (cases expression rator
                 (var-exp (var)
                          (apply
                           (ns-resolve 'eopl.core.mixed-ref-lang-parser
...
(def parse-letmutable-exp
  (complex [_ (lit-conc-seq "letmutable")
            bindings parse-bindings
            _ space*
            _ (lit-conc-seq "in")
            _ space+
            body parse-expression]
           (letmutable-exp body bindings)))
